# Redesign raster assets

Drop the PNGs here with these exact names — the code already references them,
missing files just show a dark placeholder.

| File | Used in | Size in the mockup |
| --- | --- | --- |

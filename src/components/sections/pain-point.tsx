  ...
  return (
    <section className="section-y relative">
      <div className="mx-auto max-w-3xl">
        <Reveal>
          <div className="glow-card group relative rounded-2xl bg-zinc-900/40 p-6 sm:p-10 text-left sm:text-center border border-white/5">
            <p className="text-base leading-relaxed text-zinc-300 sm:text-lg sm:leading-relaxed">

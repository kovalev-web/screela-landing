  ...
  return (
    <section className="section-y relative">
      <div className="mx-auto max-w-6xl text-left sm:text-center">
        <Reveal>
          <span className="text-eyebrow text-left sm:text-center">Comparison</span>
          <h2 className="text-h2 text-left sm:text-center">
            Why not Mobbin, Miro, or GoFullPage?
          </h2>
          <p className="text-body-lede mt-4 text-zinc-400 sm:mt-6 max-w-xl sm:max-w-3xl sm:mx-auto">

        ...
        <div className="mt-8 sm:mt-14 grid gap-4 sm:grid-cols-3 sm:gap-6">
          {personas.map((persona) => {
            ...
            return (
              <div
                key={persona.title}
                className="glow-card group relative rounded-2xl bg-zinc-900/60 p-6 sm:p-8 text-left border border-white/5 transition-all duration-300 hover:-translate-y-1"
              >

        ...
        <div className="mt-8 sm:mt-14 grid gap-6 md:grid-cols-3">
          {steps.map((step, i) => (
            <Reveal key={step.number} delay={i * 100}>
              <div className="glow-card relative flex flex-col items-center text-center rounded-2xl bg-zinc-900/60 p-6 sm:p-8 border border-white/5 h-full">
                <span className="accent-badge flex size-10 items-center justify-center rounded-full text-sm font-semibold">
                  {step.number}
                </span>

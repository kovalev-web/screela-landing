    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-24 sm:px-6 sm:py-28">
        ...
        <div className="mt-10 space-y-6 text-sm leading-relaxed text-zinc-300 sm:text-base sm:leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-zinc-100">Your account</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-100">No warranty, limitation of liability</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-zinc-100">Changes to these terms</h2>
          <p>

    ...
    <>
      ...
      <main className="mx-auto max-w-3xl px-4 py-24 sm:px-6 sm:py-28">
        ...
        <div className="mt-10 space-y-6 text-sm leading-relaxed text-muted-foreground sm:text-base sm:leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-foreground">What the extension can access</h2>
          <ul className="list-disc space-y-2 pl-5">
          ...
          <h2 className="text-lg font-semibold text-foreground">Sharing a board or flow</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-foreground">Storage and deletion</h2>
          <p>
